...
(function () {
  ...
  var T = {
    ...
    'kind.noteProject': ['Prosjekt', 'Project'],
    'kind.noteFolder':  ['Mappe', 'Folder'],
    ...
    'kindDef.noteProject': ['prosjektet', 'the project'],
    'kindDef.noteFolder':  ['mappen', 'the folder'],
    ...
    'notes.crumbTitle': ['Prosjekter og mapper – bytt og gi nytt navn',
                         'Projects and folders – switch and rename'],
    'notes.navTitleA':  ['Prosjekter og', 'Projects and'],
    'notes.navTitleB':  ['mapper', 'folders'],
    'notes.freeNotes':  ['Frie notater', 'Loose notes'],
    'notes.newNote':    ['Nytt notat', 'New note'],
    'notes.newProject': ['Nytt prosjekt', 'New project'],
    'notes.newFolder':  ['Ny mappe', 'New folder'],
    'notes.addProject': ['Nytt prosjekt', 'New project'],
    'notes.addFolder':  ['Legg til mappe', 'Add folder'],
    'notes.emptyNoProjects': ['Ingen notatprosjekter ennå.', 'No note projects yet.'],
    'notes.emptyNoProjectsHint': ['Åpne {nav} og lag det første prosjektet.',
                                  'Open {nav} and create the first project.'],
